...
Deferred.prototype.resolve = function (data) {
  ...
  _.each(this.promise.callbacks, function(cbs){
    console.log(cbs[0](this.promise.value));
  }.bind(this));
